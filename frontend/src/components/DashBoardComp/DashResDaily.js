    ...
    <Row className='revenue-section mb-3'>
      <Col className='order-box'>
        <div className='order-box-text'>
          <span className='span-medium'>Doanh thu trong ngày</span>
          <i
          ...
          >
            {(props) => (
              <Tooltip id='tooltip1' {...props}>
                Tổng số lượng doanh thu trong một ngày tính từ 0h đêm hôm trước
                đến 0h đêm hôm sau
              </Tooltip>
            )}
          </Overlay>
      ...
      <Col className='order-box'>
        <div className='order-box-text'>
          <span className='span-medium'>Số lượng order trong ngày</span>
          <i
            className='fa-solid fa-circle-info ms-2'
            ref={toolt2Ref}
          ...
          >
            {(props) => (
              <Tooltip id='tooltip1' {...props}>
                Tổng số lượng order trong một ngày tính trên mỗi lần khách thanh
                toán thành công, chú ý: số lượng này không đại biểu cho tổng số
                lượng khách hàng trong một ngày
              </Tooltip>
            )}
          </Overlay>
